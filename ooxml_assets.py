...
def _core_properties(title, description):
    return _xml(
        ...
        '<dc:creator>Trilobite</dc:creator><cp:lastModifiedBy>Trilobite</cp:lastModifiedBy>'
...
def _app_properties(kind, count=1):
    ...
    return _xml(
        ...
        '<Application>Trilobite</Application><AppVersion>1.0</AppVersion>%s'
...
def write_docx(path, title, brief, theme="arcane"):
    ...
    paragraphs = [
        ...
        _word_paragraph("Generated by Trilobite's deterministic in-house artifact forge."),
    ]
    document = _xml(
...
def _ppt_theme(accent):
    return _xml(
        '<a:theme xmlns:a="%s" name="Trilobite Theme"><a:themeElements>'
        '<a:clrScheme name="Trilobite"><a:dk1><a:srgbClr val="17152F"/></a:dk1>'
        ...
        '<a:fontScheme name="Trilobite"><a:majorFont><a:latin typeface="Aptos Display"/>'
        ...
        '<a:fmtScheme name="Trilobite"><a:fillStyleLst><a:solidFill><a:schemeClr val="phClr"/></a:solidFill>'
...
def write_pptx(path, title, brief, theme="arcane"):
    ...
    slides = [
        ...
        (
            ...
            "Generated locally by Trilobite • deterministic OOXML package • no downloaded assets • format-grounded before delivery",
        ),
    ]
    content_overrides = [
    ...
    master = _xml(
        ...
        '<p:cSld name="Trilobite Master"><p:spTree>%s</p:spTree></p:cSld>'
