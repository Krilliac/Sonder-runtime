"""Subprocess isolation for tool execution (adapter layer).
...
Moved from domain.execution.sandbox to satisfy architecture rules:
subprocess and os.environ usage belong in the adapters layer.
"""
