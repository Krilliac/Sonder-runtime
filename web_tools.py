...
def web_fetch(url, max_chars=8000, timeout=10):
    """Compatibility delegate for the packaged canonical web-fetch adapter."""
    from sonder_runtime.adapters.web_fetch import fetch_raw

    return fetch_raw(url, max_chars=max_chars, timeout=timeout)
