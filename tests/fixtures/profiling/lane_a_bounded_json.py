# Verbatim copy of lane A's sonder_runtime/domain/common/bounded_json.py (commit 254015da),
# loaded by bounded_json_double.install() only while the real module is absent
# from this tree, so lane B tests exercise the real scanner semantics
# (JsonBoundsExceeded, skipped_oversize/skipped_invalid counters).
