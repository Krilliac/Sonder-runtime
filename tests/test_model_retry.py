...
def test_model_error_identity_survives_server_reload():
    # Model identity is import-time compatibility behavior.  Reset the
    # process-local typed worker pool so this exercises a fresh server import
    # rather than asking it to bypass a prior typed configuration's primary
    # endpoint fence.
