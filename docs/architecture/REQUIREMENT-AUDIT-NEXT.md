...
| SESSION-006 | PROVEN-CONTRACT | `WP2-SESSION-006.md`; `sonder_runtime/application/session/fork.py`; `sonder_runtime/application/session/continuity.py`; `tests/production/test_session_continuity_wiring.py`. Durable source verification and HTTP fork planning are focused-tested; child materialization remains deliberately outside this slice and prevents formal promotion. |
| SESSION-007 | PROVEN-CONTRACT | `WP2-SESSION-007.md`; `sonder_runtime/application/session/repair.py`; `sonder_runtime/application/session/continuity.py`; `tests/production/test_session_continuity_wiring.py`. Restart-visible bounded repair planning and fail-closed integrity handling are focused-tested; repair does not replay effects and prevents formal promotion. |
...
| SESSION-009 | PROVEN-CONTRACT | `WP2-SESSION-009.md`, `SESSION-009-010-CHECKPOINT-PRIVACY-INTEGRATION-2026-08-21.md`, `SESSION-CONTINUITY-PRODUCTION-2026-08-21.md`; canonical composition, source-pinned projection checkpoint restart, and stale/tamper rejection are focused-tested; formal promotion remains outside this audit. |
| SESSION-010 | PROVEN-CONTRACT | `WP2-SESSION-010.md`, `SESSION-009-010-CHECKPOINT-PRIVACY-INTEGRATION-2026-08-21.md`, `SESSION-CONTINUITY-PRODUCTION-2026-08-21.md`; bounded owner-gated append-only privacy markers and public export redaction are focused-tested. Physical deletion is intentionally not introduced and formal promotion remains outside this audit. |
