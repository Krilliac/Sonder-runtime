...
|---|---|
| bootstrap/app.py | sessions, jobs, execution-spill (same SONDER_JOBS_DB override), child-sessions, extensions, agent-effects (SONDER_AGENT_EFFECTS_DB); tool audit; lane-test catalog; STATE_HOME task memory fallback |
