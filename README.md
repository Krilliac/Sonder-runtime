...
> optional; it enables nothing unless Sonder has a provider-backed integration
> for that capability.
...
| Unsafe lab mode | Experimental | Exact acknowledgement and disposable isolated hosts only; it provides no OS isolation. |
